...
var PITCHES = {
  ...
  fastball: {
    name: "Fastball",
    icon: "intent_fastball.png",
    strikes: 1,
    weight: 5,
    description: "1 Strike. Protect against it or let the count grow."
  },

  high_heat: {
    name: "High Heat",
    icon: "intent_highheat.png",
    strikes: 2,
    weight: 3,
    fromTurn: 2,
    description: "2 Strikes. Takes 2 Protect to absorb."
  },

  painted_corner: {
    name: "Painted Corner",
    icon: "intent_paintedcorner.png",
    strikes: 1,
    weight: 2,
    ignoresProtect: true,
    description: "1 Strike on the black. Protect can't touch it."
  },

  curveball: {
    name: "Curveball",
    icon: "intent_curveball.png",
    strikes: 1,
    weight: 3,
    addsJunk: true,
...
var PITCHER = {
  name: "The Starter",
  sprite: "enemy_pitcher.png",   // every regular inning is the same guy
  runsToWin: 6,
